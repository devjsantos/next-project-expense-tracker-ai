  ...
  return (
    <main className="bg-[#f8fafc] dark:bg-[#020617] min-h-screen pb-20 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 space-y-10">
        ...
        {/* 2. WALLET & ADD RECORD (2-Column Grid) */}
        ...
        {/* 4. AI INSIGHTS (Full Width - Separated) */}
        <div className="relative group">
          {/* Subtle contained glow - no "floating" shadow */}
        ...
        {/* 5. ACTIVITY STREAM - Fixed Shadow & Containment */}
        <div className="relative space-y-6 pt-4">
          ...
          {/* Main Card */}
          <div className="relative overflow-hidden bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-200 dark:border-slate-800 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] dark:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.3)]">
            {/* Optional: Subtle top-light effect to ground the card */}
            <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-slate-200 dark:via-slate-700 to-transparent opacity-50" />
